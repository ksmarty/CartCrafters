...
-- Users
INSERT INTO Users (userId, username, firstName, lastName, email, password, isAdmin)
VALUES (1, 'john123', 'John', 'Doe', 'john@example.com',
        '$s0$e0801$ZfCnHLn2aCZuPMjNcgFfRg==$/tT/0Z7W2qfI5jFXwDf/u0UlLnFbufxuUKSjD2gGllo=', FALSE), --password123
       (2, 'jane456', 'Jane', 'Doe', 'jane@example.com',
        '$s0$e0801$mKgNnLo2TVWkD1euIvDxsg==$ln7O96ik/BQyjQLldvSpXqLISy3AMoXoOlcG0Lh4KKY=', FALSE), --password456
       (3, 'bob789', 'Bob', 'Smith', 'bob@example.com',
        '$s0$e0801$WYu8BKezCd2YvQrtAtRweA==$CNbQ3sG7aLdgOjsZozoqzJ1mt3pBN354uHxdIxr2WNg=', FALSE), --password789
       (4, 'sarah101', 'Sarah', 'Johnson', 'sarah@example.com',
        '$s0$e0801$5qEFYa4sonKRDIznTdA+jg==$ngJ2ohoMPCKaX25APYJOIopfu24WpcwEGSzZ4xaCYGs=', FALSE), --password101
       (5, 'mike234', 'Mike', 'Williams', 'mike@example.com',
        '$s0$e0801$dfLqYlqG/7B97U9iP5WdAQ==$Y9L6nmbRYNVtRmwNAM2NoTsiNxp0WmayJqSQinw6vCk=', TRUE);
--password234
...
-- Order_Items
INSERT INTO Order_Items (orderItemId, orderId, productId, quantity, amount)
